...
// Transit forces that last 3-6ms, guaranteed to be sampled
static double travel_down_g = 0.0;
...
static void build_timeline() {
    ...
    // Constant acceleration needed to reach 0.002m in transit_sec.
    ...
    // Simplify to steady average transit G force (+/- 0.3g)
    travel_down_g = -0.3; 
    travel_up_g = 0.3;    
